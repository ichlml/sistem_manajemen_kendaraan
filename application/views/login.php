...
<head>
  ...
  <title>Sistem Kendaraan Dinas &mdash; Login</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?=base_url()?>assets/assets/img/logo.png" alt="logo" width="70" class="shadow-light">
            </div>
            ...
            <div class="simple-footer">
              Copyright &copy; Saipul Marom 2020
            </div>
          </div>
        </div>
      </div>
